  ...
  return (
    <section class="py-10 bg-gradient-to-b from-blue-800 to-blue-50 mt-0">
      <div class="max-w-6xl mx-auto px-6">
        <h2 class="text-3xl font-bold text-white">Nuestros Servicios</h2>

        <p class="text-white mt-4 max-w-2xl mb-15">
          Ofrecemos distintas modalidades de traslado adaptadas a tus
          necesidades.
        </p>
        ...
        <div className="mt-20">
          <div className="max-w-3xl mx-auto bg-white/70 backdrop-blur-sm border border-slate-200 rounded-xl p-8 text-center">
            ...
            <p className="text-slate-600">
              Si ya realizaste tu traslado y necesitas apoyo con tu factura,
              comunícate con nosotros y con gusto te asistimos.{" "}
            </p>
