export function WhatsAppButton(props) {
    ...
    return (
        <a
            ...
            className=" w-75  text-center inline-flex items-center gap-2 rounded-xl px-6 py-3 font-medium bg-green-500 text-white hover:bg-green-600 transition-colors"
        >
